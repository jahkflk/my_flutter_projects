...
class LoginView extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final authButtonState = ref.watch(authButtonProvider);
    final authButtonNotifier = ref.read(authButtonProvider.notifier);

    return Scaffold(
      appBar: AppBar(title: const Text('as_Login')),
      body: Padding(
